...
WPRequest.prototype._renderQuery = function () {
  ...
  queryParams.filter = _objectSpread(_objectSpread({}, populated(this._filters)), taxonomies); // Parse query parameters object into a query string, sorting the object
...
WPRequest.prototype.setHeaders = function (headers, value) {
  ...
  this._options.headers = _objectSpread(_objectSpread({}, this._options.headers || {}), headers);
  return this;
};
/**
  ...
  return objectReduce(routesByNamespace, function (namespaces, routeDefinitions, namespace) {
    ...
    namespaces[namespace] = objectReduce(routeDefinitions, function (handlers, routeDef, resource) {
      ...
      handlers[resource] = function (options) {
        return new EndpointRequest(_objectSpread(_objectSpread({}, this._options), options));
...
function createEndpointRequest(handlerSpec, resource, namespace) {
  ...
  var EndpointRequest = /*#__PURE__*/function (_WPRequest) {
    _inherits(EndpointRequest, _WPRequest);

    var _super = _createSuper(EndpointRequest);
...
function createPaginationObject(result, options, httpTransport) {
  ...
  if (links.next) {
    _paging.next = new WPRequest(_objectSpread(_objectSpread({}, options), {}, {
  ...
  if (links.prev) {
    _paging.prev = new WPRequest(_objectSpread(_objectSpread({}, options), {}, {
      transport: httpTransport,
      endpoint: links.prev
    }));
  }
...
filterMixins.filter = function (props, value) {
  ...
  this._filters = _objectSpread(_objectSpread({}, this._filters), props);
  return this;
};
/**
...
function registerRoute(namespace, restBase) {
  ...
  function endpointFactory() {
    ...
    return new EndpointRequest(_objectSpread(_objectSpread({}, options), this ? this._options : {}));
  }
...
WPAPI.prototype.url = function (url) {
  return new WPRequest(_objectSpread(_objectSpread({}, this._options), {}, {
    endpoint: url
  }));
};
/**
